 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_lgcns_ffmpegkit_FFmpegKitConfig_enableNativeRedirection(JNIEnv *, jclass);
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_lgcns_ffmpegkit_FFmpegKitConfig_disableNativeRedirection(JNIEnv *, jclass);
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_com_lgcns_ffmpegkit_FFmpegKitConfig_setNativeLogLevel(JNIEnv *, jclass, jint);
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_lgcns_ffmpegkit_FFmpegKitConfig_getNativeLogLevel(JNIEnv *, jclass);
 ...
 */
JNIEXPORT jstring JNICALL Java_com_lgcns_ffmpegkit_FFmpegKitConfig_getNativeFFmpegVersion(JNIEnv *, jclass);
 ...
 * Signature: ()Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_com_lgcns_ffmpegkit_FFmpegKitConfig_getNativeVersion(JNIEnv *, jclass);
 ...
 */
JNIEXPORT jint JNICALL Java_com_lgcns_ffmpegkit_FFmpegKitConfig_nativeFFmpegExecute(JNIEnv *, jclass, jlong, jobjectArray);
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_lgcns_ffmpegkit_FFmpegKitConfig_nativeFFmpegCancel(JNIEnv *, jclass, jlong);
